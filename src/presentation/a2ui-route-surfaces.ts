    ...
    settings: {
      ...
      components: [
        ...
        },
        {
          ...
          title: 'App builder',
          subtitle: 'Ask Wonder to add tables, redesign screens, change workflows, or adjust theme. You approve the diff.',
          tone: 'plum',
        ...
        },
        {
          kind: 'widget',
          widget: 'themePreview',
          id: 'settings_theme_preview',
          title: 'Look and feel',
          subtitle: 'Theme tokens are package config, not hand-edited screens.',
          tone: 'moss',
        },
        {
          kind: 'action',
...
export const ROUTE_SHELL_UI: A2UiSurface = {
  ...
  screens: {
    ...
    config: {
      title: 'Customize',
      subtitle: 'The AI app builder. Describe the change; Wonder produces a reviewable package diff.',
      components: [
        ...
        { kind: 'widget', widget: 'formCard', id: 'config_form_demo', title: 'Form primitive', subtitle: 'Any app can collect structured input through config.', tone: 'moss', props: { fields: [{ label: 'Name', subtitle: 'Short text' }, { label: 'Type', subtitle: 'Choice' }, { label: 'Notes', subtitle: 'Long text' }] } },
        { kind: 'widget', widget: 'checklistCard', id: 'config_checklist_demo', title: 'Checklist primitive', subtitle: 'Recipes, onboarding, QA, routines, field work, packing, chores.', tone: 'amber', props: { items: [{ title: 'Capture' }, { title: 'Review' }, { title: 'Approve' }] } },
        { kind: 'widget', widget: 'dataTable', id: 'config_table_demo', title: 'Table primitive', subtitle: 'Readable rows without custom screens.', tone: 'blue', props: { columns: [{ label: 'Name' }, { label: 'Status' }, { label: 'Owner' }], items: [{ name: 'Widget registry', status: 'Ready', owner: 'Package' }] } },
