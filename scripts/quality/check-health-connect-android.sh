...
grep -q 'android.health.connect.action.MANAGE_HEALTH_PERMISSIONS' "$root_dir/android/app/src/main/java/com/wonderfood/app/MainActivity.kt"
grep -q 'openLifeOSHealthSettings' "$root_dir/src/health/connect.ts"
grep -q 'runLifeOSHealthRoundTripProof' "$root_dir/src/health/connect.ts"
