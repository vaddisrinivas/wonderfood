...
class InMemoryHouseholdUiRepository(
    initialMemory: HouseholdUiMemory = HouseholdUiMemory(),
    ...
    private var memory: HouseholdUiMemory = initialMemory

    fun readMemory(): HouseholdUiMemory = memory

    fun replaceMemory(next: HouseholdUiMemory) {
        memory = next
    }

    fun applyDraft(draft: FoodDraft): HouseholdUiMemory {
