...
class CommandEnvelopeGoldenStabilityTest {
    ...
    fun encodedInventoryCommandEnvelopeMatchesGoldenWireJson() {
        val envelope = CommandEnvelope(
            ...
            idempotencyKey = "golden-stability-001",
